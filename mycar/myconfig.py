...
#     "PWM_STEERING_PIN": "PCA9685.1:40.15",   # PWM output pin for steering servo
#     "PWM_STEERING_SCALE": 1.0,              # used to compensate for PWM frequency differents from 60hz; NOT for adjusting steering range
#     "PWM_STEERING_INVERTED": False,         # True if hardware requires an inverted PWM pulse
#     "PWM_THROTTLE_PIN": "PCA9685.1:40.14",   # PWM output pin for ESC
...
#     "THROTTLE_FORWARD_PWM": 381,            #pwm value for max forward throttle
#     "THROTTLE_STOPPED_PWM": 379,            #pwm value for no movement
#     "THROTTLE_REVERSE_PWM": 353,            #pwm value for max reverse throttle
# }

PWM_STEERING_THROTTLE = {
    "PWM_STEERING_PIN": "PCA9685.1:40.13",   # PWM output pin for steering servo
    "PWM_STEERING_SCALE": 1.0,              # used to compensate for PWM frequency differents from 60hz; NOT for adjusting steering range
    "PWM_STEERING_INVERTED": False,         # True if hardware requires an inverted PWM pulse
    "PWM_THROTTLE_PIN": "PCA9685.1:40.12",   # PWM output pin for ESC
    "PWM_THROTTLE_SCALE": 1.0,              # used to compensate for PWM frequence differences from 60hz; NOT for increasing/limiting speed
    "PWM_THROTTLE_INVERTED": False,         # True if hardware requires an inverted PWM pulse
    "STEERING_LEFT_PWM": 443,               #pwm value for full left steering
    "STEERING_RIGHT_PWM": 333,              #pwm value for full right steering
...
#
# STEERING_CHANNEL = 15            #(deprecated) channel on the 9685 pwm board 0-15
# STEERING_LEFT_PWM = 1000         #pwm value for full left steering
# STEERING_RIGHT_PWM = 10        #pwm value for full right steering
# THROTTLE_CHANNEL = 14            #(deprecated) channel on the 9685 pwm board 0-15
...
PWM_STEERING_THROTTLE = {
	"PWM_STEERING_PIN": "PCA9685.1:40.15",   # PWM output pin for steering servo
	"PWM_STEERING_SCALE": 1,              # used to compensate for PWM frequency differents from 60hz; NOT for adjusting steering range
	"PWM_STEERING_INVERTED": False,         # True if hardware requires an inverted PWM pulse
	"PWM_THROTTLE_PIN": "PCA9685.1:40.14",   # PWM output pin for ESC
	"PWM_THROTTLE_SCALE": 1,              # used to compensate for PWM frequence differences from 60hz; NOT for increasing/limiting speed
	"PWM_THROTTLE_INVERTED": False,         # True if hardware requires an inverted PWM pulse
	"STEERING_LEFT_PWM": 460,               #pwm value for full left steering
	"STEERING_RIGHT_PWM": 290,              #pwm value for full right steering
	"THROTTLE_FORWARD_PWM": 384,            #pwm value for max forward throttle
